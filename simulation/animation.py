...
class SimVisual(object):
    ...
    def __init__(self, env):
        ...
        self.pivot_point = env.pivot_point1          # e.g., np.array([2.0, 0.0, 2.0])
        self.pivot_point2 = env.pivot_point2
        self.pivot_point3 = env.pivot_point3
        self.frames = []
        #
        # create figure
        ...
        self.l_pend2_px, = self.ax_pos.plot([], [], '--r', label='pend2_x')
        self.l_pend3_px, = self.ax_pos.plot([], [], '--r', label='pend3_x')
        self.l_quad_py, = self.ax_pos.plot([], [], '-g', label='quad_y')
        self.l_pend_py, = self.ax_pos.plot([], [], '--g', label='pend_y')
        self.l_pend2_py, = self.ax_pos.plot([], [], '--g', label='pend2_y')
        self.l_pend3_py, = self.ax_pos.plot([], [], '--g', label='pend3_y')
        self.l_quad_pz, = self.ax_pos.plot([], [], '-b', label='quad_z')
        self.l_pend_pz, = self.ax_pos.plot([], [], '--b', label='pend_z')
        self.l_pend2_pz, = self.ax_pos.plot([], [], '--b', label='pend2_z')
        self.l_pend3_pz, = self.ax_pos.plot([], [], '--b', label='pend3_z')
        ...
        self.l_pend2_vx, = self.ax_vel.plot([], [], '--r', label='pend2_vx')
        self.l_pend3_vx, = self.ax_vel.plot([], [], '--r', label='pend3_vx')
        self.l_quad_vy, = self.ax_vel.plot([], [], '-g', label='quad_vy')
        self.l_pend_vy, = self.ax_vel.plot([], [], '--g', label='pend_vy')
        self.l_pend2_vy, = self.ax_vel.plot([], [], '--g', label='pend2_vy')
        self.l_pend3_vy, = self.ax_vel.plot([], [], '--g', label='pend3_vy')
        self.l_quad_vz, = self.ax_vel.plot([], [], '-b', label='quad_vz')
        self.l_pend_vz, = self.ax_vel.plot([], [], '--b', label='pend_vz')
        self.l_pend2_vz, = self.ax_vel.plot([], [], '--b', label='pend2_vz')
        self.l_pend3_vz, = self.ax_vel.plot([], [], '--b', label='pend3_vz')
        ...
        self.l_pend2_ax, = self.ax_att.plot([], [], '--r', label='pend2_ax')
        self.l_pend3_ax, = self.ax_att.plot([], [], '--r', label='pend3_ax')
        self.l_quad_ay, = self.ax_att.plot([], [], '-g', label='quad_ay')
        self.l_pend_ay, = self.ax_att.plot([], [], '--g', label='pend_ay')
        self.l_pend2_ay, = self.ax_att.plot([], [], '--g', label='pend2_ay')
        self.l_pend3_ay, = self.ax_att.plot([], [], '--g', label='pend3_ay')
        self.l_quad_az, = self.ax_att.plot([], [], '-b', label='quad_az')
        self.l_pend_az, = self.ax_att.plot([], [], '--b', label='pend_az')
        self.l_pend2_az, = self.ax_att.plot([], [], '--b', label='pend2_az')
        self.l_pend3_az, = self.ax_att.plot([], [], '--b', label='pend3_az')
        ...
        self.l_pend2_pred_traj, = self.ax_3d.plot([], [], [], 'ko')
        self.l_pend3_pred_traj, = self.ax_3d.plot([], [], [], 'ko')
        #
        ...
        #
        self.l_pend2, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        self.l_pend2_edge1, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        self.l_pend2_edge2, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        self.l_pend2_edge3, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        self.l_pend2_edge4, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        #
        self.l_pend3, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        self.l_pend3_edge1, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        self.l_pend3_edge2, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        self.l_pend3_edge3, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        self.l_pend3_edge4, = self.ax_3d.plot([], [], [], 'b', linewidth=2)
        #
        ...
        self.ax_3d.scatter(self.pivot_point2[0], self.pivot_point2[1], self.pivot_point2[2], marker='o', color='r')
    ...
    def reset_buffer(self, ):
        ...
        self.pend2_pos, self.pend2_vel, self.pend2_att = [], [], []
        self.pend3_pos, self.pend3_vel, self.pend3_att = [], [], []
        self.quad_hist = []
    ...
    def init_animate(self,):
        ...
        self.l_pend2_px.set_data([], [])
        self.l_pend3_px.set_data([], [])
        self.l_quad_py.set_data([], [])
        self.l_pend_py.set_data([], [])
        self.l_pend2_py.set_data([], [])
        self.l_pend3_py.set_data([], [])
        self.l_quad_pz.set_data([], [])
        self.l_pend_pz.set_data([], [])
        self.l_pend2_pz.set_data([], [])
        self.l_pend3_pz.set_data([], [])

        # Initialize velocity.....
        self.l_quad_vx.set_data([], [])
        self.l_pend_vx.set_data([], [])
        self.l_pend2_vx.set_data([], [])
        self.l_pend3_vx.set_data([], [])
        self.l_quad_vy.set_data([], [])
        self.l_pend_vy.set_data([], [])
        self.l_pend2_vy.set_data([], [])
        self.l_pend3_vy.set_data([], [])
        self.l_quad_vz.set_data([], [])
        self.l_pend_vz.set_data([], [])
        self.l_pend2_vz.set_data([], [])
        self.l_pend3_vz.set_data([], [])

        # Initialize attitude.....
        self.l_quad_ax.set_data([], [])
        self.l_pend_ax.set_data([], [])
        self.l_pend2_ax.set_data([], [])
        self.l_pend3_ax.set_data([], [])
        self.l_quad_ay.set_data([], [])
        self.l_pend_ay.set_data([], [])
        self.l_pend2_ay.set_data([], [])
        self.l_pend3_ay.set_data([], [])
        self.l_quad_az.set_data([], [])
        self.l_pend_az.set_data([], [])
        self.l_pend2_az.set_data([], [])
        self.l_pend3_az.set_data([], [])
        ...
        self.l_pend2_pred_traj.set_data([], [])
        self.l_pend2_pred_traj.set_3d_properties([])
        self.l_pend3_pred_traj.set_data([], [])
        self.l_pend3_pred_traj.set_3d_properties([])
        # Initialize pendulum plot
        self.l_pend.set_data([], [])
        self.l_pend.set_3d_properties([])
        self.l_pend2.set_data([], [])
        self.l_pend2.set_3d_properties([])
        self.l_pend3.set_data([], [])
        self.l_pend3.set_3d_properties([])
        #
        ...
        #
        self.l_pend2_edge1.set_data([], [])
        self.l_pend2_edge1.set_3d_properties([])
        self.l_pend2_edge2.set_data([], [])
        self.l_pend2_edge2.set_3d_properties([])
        self.l_pend2_edge3.set_data([], [])
        self.l_pend2_edge3.set_3d_properties([])
        self.l_pend2_edge4.set_data([], [])
        self.l_pend2_edge4.set_3d_properties([])
        #
        self.l_pend3_edge1.set_data([], [])
        self.l_pend3_edge1.set_3d_properties([])
        self.l_pend3_edge2.set_data([], [])
        self.l_pend3_edge2.set_3d_properties([])
        self.l_pend3_edge3.set_data([], [])
        self.l_pend3_edge3.set_3d_properties([])
        self.l_pend3_edge4.set_data([], [])
        self.l_pend3_edge4.set_3d_properties([])
    ...
    def update(self, data_info):
        ...
        pend_obs2 = info["pend_obs2"]
        pend_obs3 = info["pend_obs3"]
        pend_corners = info["pend_corners"]
        pend_corners2 = info["pend_corners2"]
        pend_corners3 = info["pend_corners3"]
        ...
        if update:
            ...
            #
            self.pend2_pos.append(pend_obs2[0:3])
            self.pend2_att.append(pend_obs2[3:6])
            self.pend2_vel.append(pend_obs2[6:9])
            #
            self.pend3_pos.append(pend_obs3[0:3])
            self.pend3_att.append(pend_obs3[3:6])
            self.pend3_vel.append(pend_obs3[6:9])
        ...
        if len(self.ts) == 0:
            ...
            #
            pend2_pos_arr = np.array(self.pend2_pos)
            self.l_pend2_px.set_data(self.ts, pend2_pos_arr[:, 0])
            self.l_pend2_py.set_data(self.ts, pend2_pos_arr[:, 1])
            self.l_pend2_pz.set_data(self.ts, pend2_pos_arr[:, 2])
            #
            pend3_pos_arr = np.array(self.pend3_pos)
            self.l_pend3_px.set_data(self.ts, pend3_pos_arr[:, 0])
            self.l_pend3_py.set_data(self.ts, pend3_pos_arr[:, 1])
            self.l_pend3_pz.set_data(self.ts, pend3_pos_arr[:, 2])
            ...
            #
            #self.l_pend2.set_data([self.pivot_point2[0], pend_obs2[kPosX]], [self.pivot_point2[1], pend_obs2[kPosY]] )
            # self.l_pend2.set_3d_properties([self.pivot_point2[2], pend_obs2[kPosZ]])
            ...
            c1, c2, c3, c4 = pend_corners2
            #
            self.l_pend2_edge1.set_data([c1[0], c2[0]], [c1[1], c2[1]])
            self.l_pend2_edge1.set_3d_properties([c1[2], c2[2]])
            self.l_pend2_edge2.set_data([c2[0], c2[0]], [c2[1], c4[1]])
            self.l_pend2_edge2.set_3d_properties([c2[2], c4[2]])
            self.l_pend2_edge3.set_data([c4[0], c3[0]], [c4[1], c3[1]])
            self.l_pend2_edge3.set_3d_properties([c4[2], c3[2]])
            self.l_pend2_edge4.set_data([c3[0], c1[0]], [c3[1], c1[1]])
            self.l_pend2_edge4.set_3d_properties([c3[2], c1[2]])

            c1, c2, c3, c4 = pend_corners3
            #
            self.l_pend3_edge1.set_data([c1[0], c2[0]], [c1[1], c2[1]])
            self.l_pend3_edge1.set_3d_properties([c1[2], c2[2]])
            self.l_pend3_edge2.set_data([c2[0], c2[0]], [c2[1], c4[1]])
            self.l_pend3_edge2.set_3d_properties([c2[2], c4[2]])
            self.l_pend3_edge3.set_data([c4[0], c3[0]], [c4[1], c3[1]])
            self.l_pend3_edge3.set_3d_properties([c4[2], c3[2]])
            self.l_pend3_edge4.set_data([c3[0], c1[0]], [c3[1], c1[1]])
            self.l_pend3_edge4.set_3d_properties([c3[2], c1[2]])
        ...
        return self.l_quad_px, self.l_quad_py, self.l_quad_pz, \
            ...
            self.l_pend_pred_traj, self.l_quad_x, self.l_quad_y,  self.l_quad_z, \
            self.l_pend_edge1, self.l_pend_edge2, self.l_pend_edge3, self.l_pend_edge4, \
            self.l_pend2_px, self.l_pend2_py, self.l_pend2_pz, self.l_pend2, \
            self.l_pend2_edge1, self.l_pend2_edge2, self.l_pend2_edge3, self.l_pend2_edge4, \
            self.l_pend3_px, self.l_pend3_py, self.l_pend3_pz, self.l_pend3, \
            self.l_pend3_edge1, self.l_pend3_edge2, self.l_pend3_edge3, self.l_pend3_edge4
